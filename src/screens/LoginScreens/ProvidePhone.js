...
export class ProvidePhone extends Component {
    render() {
        return (
        <View style={styles.Container} >
            ...
            <ScrollView>
                <View style={styles.BodyView}>
                    <Text style={styles.HeaderText} >Verify you phone number</Text>
                    <Text style={styles.SubText} >We have sent you an SMS with a code to (+250) 788 132 456 879</Text>
